...
const Social: React.FC = () => {
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center gap-7 absolute top-[50%] left-15 -translate-y-1/2 z-50"
    ...
    >
      {socialLinks.map(({ Icon, href, label }, index) => (
        <motion.div key={label} variants={iconVariants} className="relative">
          ...
          >
            <motion.div
              className="text-4xl text-custom-pink cursor-pointer relative"
              whileHover={{
